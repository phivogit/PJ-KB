...
class VKeyboard:
    def __init__(self, root=Tk()):
        ...
        self.tips_space = Button(infoframe7, text="Enjoy the buttons :)", bg=self.black, relief=FLAT, disabledforeground="white", font=self.bottomfont, state=DISABLED, height=1)
    ...
    def updateUserPreference(self, event = None):
        ...
        self.prefFile = open("MarkovChain\\markov_chain.txt", "a")
